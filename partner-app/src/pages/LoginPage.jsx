  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-4 text-center text-3xl font-bold text-gray-900">GELIS Mitra</h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          Login untuk mengelola warung Anda
        </p>
      </div>
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    className="pl-12 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                    maxLength={13}
                    required
                  />
                </div>
              ...
              <div className="text-center">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    window.open(`https://wa.me/${adminWhatsApp}?text=Halo Admin, saya ingin mendaftar sebagai mitra GELIS DELIVERY`, '_blank');
                  }}
            ...
            <form onSubmit={handleVerifyOTP} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm text-center text-2xl tracking-widest"
                  maxLength={6}
                  required
                />
                <p className="mt-2 text-xs text-gray-500">
